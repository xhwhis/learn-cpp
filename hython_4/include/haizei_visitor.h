...
class IntValuePowerOpVisitor : public IntValueOperator {
public:
    IntValuePowerOpVisitor(IntValue *);
    void visit(IntValue *);
    void visit(FloatValue *);
};
...
class FloatValuePowerOpVisitor : public FloatValueOperator {
public:
    FloatValuePowerOpVisitor(FloatValue *);
    void visit(IntValue *);
    void visit(FloatValue *);
};
